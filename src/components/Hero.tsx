  ...
  return (
    ...
    >
      <div data-aos="fade-up" className="w-1/2 space-y-1 text-left">
        <h1 className="text-7xl font-bold font-openSans mt-4 text-gray-950" data-aos="fade-up" data-aos-delay="100">
          I&apos;m Ram <span className="text-purple-800">Naren</span>
        </h1>
        <p className="text-md mt-3 mb-6 text-justify w-3/4" data-aos="fade-up" data-aos-delay="100">
      ...
      <div className="relative w-1/2 flex justify-center">
        <div className="absolute w-96 h-96 bg-purple-600 -z-10 custom-shape-1 top-35" data-aos="fade-up" data-aos-delay="250"></div>
        <Image
          src={profile}
          alt="RamNaren"
          width={350}
